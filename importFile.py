...
covid_data = pd.read_csv('/home/pi/grafana/covid_data_formatted_dates.csv', index_col=False, delimiter = ',')
covid_data.head()

try:
	conn = msql.connect(host='localhost', database='db_grafana', user='grafanauser',  
                        password='ThePassword')#give ur username, password
